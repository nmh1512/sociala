                            ...
                            <router-link
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs mt-1 text-gray-400">{{ item.mutualFriends + ' ' + $t("mutual_friends") }}</p>
                                    </div>
                                </div>
                            </router-link>
                            <div class="flex gap-x-2 mt-4">
                                <button class="btn bg-color-theme-blue border-0 ring-0 rounded-3xl w-24 h-9 min-h-9 text-xs text-white hover:bg-color-theme-blue">{{ $t("confirm") }}</button>
                                <button class="btn bg-gray-200 border-0 ring-0 rounded-3xl w-24 h-9 min-h-9 text-xs text-gray-600 hover:bg-gray-400">{{ $t("delete") }}</button>
                            </div>
                        </div>
                    </div>
                </div>
